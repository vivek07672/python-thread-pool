...
connection_pool = NewConnectionPool()
    ...
    def run(self):
        ...
        try:
            ...
            mysql_connection = connection_pool.get_connection(self.get_user(),self.get_host(),
                                                              self.get_database(),
                                                              self.get_password(),self.get_thread_id())
            ...
            # 
            #===================================================================
            connection_pool.put_connection(self.get_user(),self.get_host(),
                                           self.get_database(),self.get_password(),
                                           mysql_connection,self.get_thread_id())
